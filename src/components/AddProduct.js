...
const AddProduct = ({handleLoggedInUser}) => {
    ...
    const [Pass, set_Pass] = useState('');
        ...
        const handleAddProduct = (e) => {
            ...
            var registerModel = {
                Name: e.target.elements[4].value, 
                Description: e.target.elements[5].value, 
                Category: e.target.elements[4].value, 
                Price: e.target.elements[2].value, 
                StockQuality: e.target.elements[3].value,
                Vendor_ID: e.target.elements[3].value
            };
                        ...
                        <div className="col-lg-5 offset-lg-1 col-md-12 order-1 order-lg-2">
                            <div className="contact-form-content pt-sm-55 pt-xs-55">
                                ...
                                <div className="contact-form">
                                    <form onClick={handleAddProduct}  id="contact-form" action="http://demo.hasthemes.com/limupa-v3/limupa/mail.php" method="post">
